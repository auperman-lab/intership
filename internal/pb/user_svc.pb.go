...
var file_user_svc_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x32, 0x80, 0x02, 0x0a, 0x0e, 0x55, 0x73, 0x65, 0x72, 0x43, 0x6f, 0x6e,
...
var file_user_svc_proto_depIdxs = []int32{
	...
	4, // 4: pb.UserController.CreateUser:output_type -> pb.CreateUserResponse
	5, // 5: pb.UserController.LoginUser:output_type -> pb.LoginUserResponse
	6, // 6: pb.UserController.DeleteUser:output_type -> pb.DeleteUserResponse
	7, // 7: pb.UserController.GetUser:output_type -> pb.GetUserResponse
